  ...
  return (
    <Dialog open={!!item} onOpenChange={(o) => !o && handleClose()}>
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader><DialogTitle className="flex items-center gap-2"><Pencil className="size-5 text-primary" /> Edit QAC Step</DialogTitle><DialogDescription>{item?.cleaningTypeName} — Step {item?.stepNumber}</DialogDescription></DialogHeader>
